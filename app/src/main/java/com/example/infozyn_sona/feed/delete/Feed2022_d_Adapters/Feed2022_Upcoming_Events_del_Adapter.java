package com.example.infozyn_sona.feed.delete.Feed2022_d_Adapters;
...
import com.example.infozyn_sona.feed.delete.Feed2022_d.FeedDel2022_Upcoming_Events;
import com.example.infozyn_sona.feed.delete.Update_Feed.update_2021.UpdateFeed2021_Upcoming_Events;
import com.example.infozyn_sona.feed.delete.Update_Feed.update_2022.UpdateFeed2022_Upcoming_Events;
...
public class Feed2022_Upcoming_Events_del_Adapter extends RecyclerView.Adapter<Feed2022_Upcoming_Events_del_Adapter.Viewholder2022_upev_d> {

    private ArrayList<sonaNews> arrayList;
    private Context context;

    AlertDialog.Builder builder;
    Feed2022_Upcoming_Events_del_Adapter.OnItemClickListerner onItemClickListerner;

    DatabaseReference reference;
    boolean testclick=false;

    public Feed2022_Upcoming_Events_del_Adapter(ArrayList<sonaNews>arrayList,Context context){
    ...
    @NonNull
    @Override
    public Feed2022_Upcoming_Events_del_Adapter.Viewholder2022_upev_d onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater= LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.view_news_delete,parent,false);
        return new Feed2022_Upcoming_Events_del_Adapter.Viewholder2022_upev_d(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Feed2022_Upcoming_Events_del_Adapter.Viewholder2022_upev_d holder, int position) {

        sonaNews sonaNews=arrayList.get(position);

        DatabaseReference Likref= FirebaseDatabase.getInstance().getReference("Likes");
        DatabaseReference Delref=FirebaseDatabase.getInstance().getReference("Notice").child("2022").child("Upcoming Events");

        FirebaseUser firebaseUser= FirebaseAuth.getInstance().getCurrentUser();
        String userid=firebaseUser.getUid();
        String postkey= sonaNews.getKey();

        holder.getLikebuttonstatus_2022_upev_del(postkey,userid);
        ...
        holder.update_d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(context, UpdateFeed2022_Upcoming_Events.class);
                                ...
                                Delref.child(postkey).removeValue()
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                Intent intent=new Intent(context, FeedDel2022_Upcoming_Events.class);
    ...
    public class Viewholder2022_upev_d extends RecyclerView.ViewHolder {
        ...
        public Viewholder2022_upev_d(@NonNull View itemView) {
            super(itemView);
        ...
        public void getLikebuttonstatus_2022_upev_del(final String postkey,final String userid){
    ...
    public void setOnItemClickListerner(Feed2022_Upcoming_Events_del_Adapter.OnItemClickListerner onItemClickListerner){
