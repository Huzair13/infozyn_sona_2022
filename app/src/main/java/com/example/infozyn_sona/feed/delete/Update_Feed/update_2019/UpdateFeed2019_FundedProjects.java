...
public class UpdateFeed2019_FundedProjects extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_feed2019_funded_projects);
        ...
        update_title_txt=findViewById(R.id.noticeTitle_update2019_fp);
        update_message_txt=findViewById(R.id.noticeMessage_update2019_fp);
        update_notice_btn=findViewById(R.id.uploadNoticeBtn_update2019_fp);
        update_notice_img=findViewById(R.id.addimage_update2019_fp);
        notice=findViewById(R.id.noticeImageView_update2019_fp);

        reference= FirebaseDatabase.getInstance().getReference().child("Notice").child("2019").child("Funded Projects");
    ...
    private void uploadImage() {
        ...
        uploadTask.addOnCompleteListener(UpdateFeed2019_FundedProjects.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(UpdateFeed2019_FundedProjects.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void UpdateData(String s) {
        ...
        reference.child(uniquekey).updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onSuccess(Object o) {
                pd.dismiss();
                Toast.makeText(UpdateFeed2019_FundedProjects.this, "Post Updated Successfully", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(UpdateFeed2019_FundedProjects.this, FeedDel2019_FundedProjects.class);
