...
import com.example.infozyn_sona.feed.delete.Update_Feed.update_2020.UpdateFeed2020_FineArts;
...
public class Feed2020_FineArts_del_Adapter extends RecyclerView.Adapter<Feed2020_FineArts_del_Adapter.Viewholder2020_FineArts_d> {

    private ArrayList<sonaNews> arrayList;
    private Context context;

    AlertDialog.Builder builder;
    Feed2020_FineArts_del_Adapter.OnItemClickListerner onItemClickListerner;

    DatabaseReference reference;
    boolean testclick=false;

    public Feed2020_FineArts_del_Adapter(ArrayList<sonaNews>arrayList,Context context){
    ...
    @NonNull
    @Override
    public Feed2020_FineArts_del_Adapter.Viewholder2020_FineArts_d onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater= LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.view_news_delete,parent,false);
        return new Feed2020_FineArts_del_Adapter.Viewholder2020_FineArts_d(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Feed2020_FineArts_del_Adapter.Viewholder2020_FineArts_d holder, int position) {

        sonaNews sonaNews=arrayList.get(position);

        DatabaseReference Likref= FirebaseDatabase.getInstance().getReference("Likes");
        DatabaseReference Delref=FirebaseDatabase.getInstance().getReference("Notice").child("2020").child("FineArts");

        FirebaseUser firebaseUser= FirebaseAuth.getInstance().getCurrentUser();
        String userid=firebaseUser.getUid();
        String postkey= sonaNews.getKey();

        holder.getLikebuttonstatus_2020_FineArts_del(postkey,userid);
        ...
        holder.update_d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(context, UpdateFeed2020_FineArts.class);
                                ...
                                Delref.child(postkey).removeValue()
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                Intent intent=new Intent(context, FeedDel2020_FineArts.class);
    ...
    public class Viewholder2020_FineArts_d extends RecyclerView.ViewHolder {
        ...
        public Viewholder2020_FineArts_d(@NonNull View itemView) {
            super(itemView);
        ...
        public void getLikebuttonstatus_2020_FineArts_del(final String postkey,final String userid){
    ...
    public void setOnItemClickListerner(Feed2020_FineArts_del_Adapter.OnItemClickListerner onItemClickListerner){
