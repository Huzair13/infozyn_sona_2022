...
public class Feed2021_Awards_del_Adapter extends RecyclerView.Adapter<Feed2021_Awards_del_Adapter.Viewholder2021_awards_d> {
    ...
    Feed2021_Awards_del_Adapter.OnItemClickListerner onItemClickListerner;


    DatabaseReference reference;
    boolean testclick=false;

    public Feed2021_Awards_del_Adapter(ArrayList<sonaNews>arrayList,Context context){
    ...
    @NonNull
    @Override
    public Feed2021_Awards_del_Adapter.Viewholder2021_awards_d onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater= LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.view_news_delete,parent,false);
        return new Feed2021_Awards_del_Adapter.Viewholder2021_awards_d(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Feed2021_Awards_del_Adapter.Viewholder2021_awards_d holder, int position) {

        sonaNews sonaNews=arrayList.get(position);

        DatabaseReference Likref= FirebaseDatabase.getInstance().getReference("Likes");
        DatabaseReference Delref=FirebaseDatabase.getInstance().getReference("Notice").child("2021").child("Awards");

        FirebaseUser firebaseUser= FirebaseAuth.getInstance().getCurrentUser();
        String userid=firebaseUser.getUid();
        String postkey= sonaNews.getKey();

        holder.getLikebuttonstatus_2021_Awards_del(postkey,userid);
        ...
        holder.update_d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(context, UpdateFeed2021_Awards.class);
                                ...
                                Delref.child(postkey).removeValue()
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                Intent intent=new Intent(context, FeedDel2021_awards.class);
    ...
    public class Viewholder2021_awards_d extends RecyclerView.ViewHolder {
        ...
        public Viewholder2021_awards_d(@NonNull View itemView) {
            super(itemView);
        ...
        public void getLikebuttonstatus_2021_Awards_del(final String postkey,final String userid){
    ...
    public void setOnItemClickListerner(Feed2021_Awards_del_Adapter.OnItemClickListerner onItemClickListerner){
