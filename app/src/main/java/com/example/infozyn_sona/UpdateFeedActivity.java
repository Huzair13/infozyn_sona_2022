...
public class UpdateFeedActivity extends AppCompatActivity {
    ...
    private void uploadImage() {
        ...
        uploadTask.addOnCompleteListener(UpdateFeedActivity.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(UpdateFeedActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void UpdateData(String s) {
        ...
        reference.child(uniquekey).updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onSuccess(Object o) {
                pd.dismiss();
                Toast.makeText(UpdateFeedActivity.this, "Post Updated Successfully", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(UpdateFeedActivity.this, DeleteNoticeActivity.class);
